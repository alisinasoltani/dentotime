        ...
        try {
            ...
            if (debouncedSearch.trim() !== "") {
                filteredData = data.filter((thread: any) => {
                    const otherUser = thread.participant || thread.participants?.[0];
                ...
                {threads.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full p-4 text-center">
                        ...
                        <p className="text-gray-300 text-xs mt-1">
                            {debouncedSearch ? "عبارت دیگری را جستجو کنید" : "برای شروع، روی گفتگوی جدید کلیک کنید."}
                        </p>
                    </div>
                ) : (
                            ...
                            <div key={thread.id} className="w-full">
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="font-semibold text-gray-800 text-sm text-right truncate">
