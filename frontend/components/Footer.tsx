    ...
    <>
      <section id="contact" className="scroll-mt-28 bg-[linear-gradient(135deg,#ECFCFD_0%,#E0F5F8_48%,#D9F2F5_100%)] py-16 sm:py-20 lg:py-24" dir="rtl">
        <div className="mx-auto max-w-[1180px] px-4 sm:px-6">
          ...
          <div className="mt-10 grid overflow-hidden rounded-[24px] border border-white/80 bg-white/72 shadow-[0_24px_70px_rgba(50,139,154,0.12)] backdrop-blur-sm lg:grid-cols-[0.88fr_1.12fr]">
            <div className="order-2 flex flex-col justify-center gap-6 border-t border-[#D5EDEF] p-6 sm:p-10 lg:order-1 lg:border-l lg:border-t-0 lg:p-12">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                {contactItems.map((item) => {
                  ...
                  return (
                    <a key={item.value} href={item.href} className="group flex min-h-14 items-center gap-3 rounded-2xl px-2 transition hover:bg-white">
                      <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-[#E1FCFC] text-[#2993A3] group-hover:bg-[#2993A3] group-hover:text-white">
              ...
              <div className="flex items-start gap-3 rounded-2xl bg-white/72 p-4">
            ...
            <div className="order-1 flex flex-col gap-6 p-6 sm:p-10 lg:order-2 lg:p-12">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group relative min-h-[260px] overflow-hidden rounded-[20px] border border-[#B9DEE3] bg-[#EAF7F8] focus-visible:outline-3 focus-visible:outline-[#75C1C7]/50"
      ...
      <footer className="bg-[linear-gradient(90deg,#E1FCFC_0%,#CDF7FF_50%,#B5FBFF_100%)]" dir="rtl">
        <div className="mx-auto grid min-h-20 max-w-[1180px] items-center gap-4 px-4 py-5 sm:grid-cols-2 sm:px-6">
          ...
          <div className="flex items-center justify-center gap-2 sm:justify-end" aria-label="شبکه‌های اجتماعی دنتوتایم">
            <a href="https://ble.ir" target="_blank" rel="noreferrer" className="flex size-11 items-center justify-center overflow-hidden rounded-full border border-white/80 bg-white text-[#2993A3] shadow-sm transition hover:-translate-y-0.5" aria-label="دنتوتایم در بله">
              <Image src="/icons/bale-logo.png" alt="" width={44} height={44} className="size-full object-cover" />
            </a>
            <a href="https://wa.me/989124673291" target="_blank" rel="noreferrer" className="flex size-11 items-center justify-center rounded-full border border-white/80 bg-white text-[#25D366] shadow-sm transition hover:-translate-y-0.5" aria-label="دنتوتایم در واتساپ">
              <SiWhatsapp className="size-5" aria-hidden="true" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="flex size-11 items-center justify-center rounded-full border border-white/80 bg-white text-[#C13584] shadow-sm transition hover:-translate-y-0.5" aria-label="دنتوتایم در اینستاگرام">
